...
The application can potentially run (though not tested) on Linux or Windows (and potentially other operating systems that can run the Java Runtime Environment v.8 or later). Choose the getting started guide for operating system that your edge PC will run:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA4MDIyNDA1MywtMTk2ODA3MThdfQ==
-->