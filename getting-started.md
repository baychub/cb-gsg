...
5. Connect the PoE+ switch to the router and power on the switch.
	...
	The sensor LEDs will go through a series of patterns, and after 1-2 minutes should be ((fill in here)). When the RSP Controller Application is running, the LEDs will then ((fill in here)). If the LEDs are not flashing as expected
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI5ODU5MzM3NSwxNjk0MjU4MjAzXX0=
-->