...
- [RSP Controller API Guide](https://github.com/intel/rsp-sw-toolkit-gw/blob/master/docs/Intel-RSP-Controller-App_API_Guide.pdf): Reference for getting data from and configuration commands to the RSP Controller software
...
- [Use Cases](https://github.com/intel/rsp-sw-toolkit-gw/tree/master/examples/use-cases): Implementation guidance for common use cases in areas like retail and factory floors
